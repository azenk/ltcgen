...
func TestFrameEncode(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]byte{0x95, 0xBA, 0x03, 0x4C, 0x01, 0x99, 0x32, 0xA7, 0x3F, 0xFD},
		},
		{
			"25fps-0-userdata",
